...
def main(args=None):
	...
	retinanet = torch.load('csv_retinanet_0.pt')
	use_gpu = True
	...
	# input_folder='./data/gwm_whole_image'
	input_folder='./data/traffic_image_datasets'
	root=''
	...
	# for idx, data in enumerate(dataloader_val):
			...
			with torch.no_grad():
				print('********************************************************\n')
				st = time.time()
				scores, classification, transformed_anchors = retinanet(data.cuda().float(),gen_anchor1,gen_anchor2)
